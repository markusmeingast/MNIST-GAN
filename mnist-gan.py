...
for epoch in range(EPOCHS):
    ...
    for batch in range(BATCHES):
        ...
        w_fake = np.zeros((BATCH_SIZE, 1), dtype=int)
...
mp.xlabel('batch')
mp.ylabel('loss')
mp.legend(['d1_loss', 'd2_loss', 'd3_loss', 'g1_loss',  'g2_loss',  'g3_loss', 'e1_loss'])
mp.show()
...
#input_string = 0*np.ones((CLS_SHP,)).astype(int)
...
acgan_model.save('acgan_model.h5')
